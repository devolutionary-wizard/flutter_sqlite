...
// insert data
  Future<int> insertPlanets(List<PlanetModel> planets) async {
    int result = 0;
...
// retrieve data
  Future<List<PlanetModel>> retrievePlanets() async {
    final Database db = await initializedDB();
    final List<Map<String, Object?>> queryResult = await db.query('planets');
    return queryResult.map((e) => PlanetModel.fromMap(e)).toList();
  }
